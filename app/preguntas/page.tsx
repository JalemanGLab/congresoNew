...
import { Users, Zap, LifeBuoy, ThumbsUp, Search, Home } from "lucide-react";
...
const Page = () => {
  ...
  return (
    <div className="w-full max-w-[1200px] px-6 mx-auto py-10 bg-white space-y-6">
      <div className="flex items-center justify-between">
        <div className="text-3xl font-bold flex items-center gap-2">
          <LuCircleHelp className="text-neutral-900 text-2xl md:text-3xl" />
        ...
        <Link
          href="/"
          className="flex items-center gap-2 px-4 py-2 rounded-l text-neutral-700 transition-colors duration-200"
        >
          <Home className="h-6 w-6" />
          <span className="text-sm hidden md:block">Volver al inicio</span>
        </Link>
      </div>
      {/* Barra de búsqueda */}
      <div className="w-full flex flex-col sm:flex-row justify-center gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 rounded-xl  outline-none border bg-white text-black border-neutral-200 focus:border-neutral-400 focus:ring-2 focus:ring-neutral-100 transition-all duration-200"
            value={searchQuery}
            ...
            >
              ...
              >
                ...
                <AccordionContent className="text-neutral-600 px-4 pb-4">
                  El Congreso Magno 3.0 se llevará a cabo del [fecha] al [fecha]
                  en [lugar]. Las sesiones comenzarán desde las 8:00 AM hasta
                  las 6:00 PM.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="text-neutral-600 px-4 pb-4">
                  El evento se realizará en [lugar específico], ubicado en
                  [dirección completa]. Contamos con estacionamiento disponible
                  y fácil acceso al transporte público.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
              ...
              >
                ...
                <AccordionContent className="text-neutral-600 px-4 pb-4">
                  ...
                  <p className="mt-3 bg-neutral-50 p-3 rounded-lg text-sm">
                    <span className="font-medium">Consejo:</span> Ten a la mano

...
const MenuItem = ({ text, childrenIcon, href, onClick }: MenuItemDTO) => {
  return href ? (
    <Link
      href={href}
      className="cursor-pointer group relative flex w-full justify-center rounded-sm px-2 py-1.5 text-lg text-neutral-700 hover:bg-neutral-100 hover:text-neutral-800"
    >
      {childrenIcon}

  ...
  return (
    <div className="w-full p-6 sm:p-6 lg:p-8 text-white rounded-t-lg lg:rounded-tr-none lg:rounded-l-lg flex flex-col gap-4 ">
      <div className="mb-2 md:mb-4 hidden md:block">
        <button className="bg-green-400 text-black font-bold py-1 px-4 text-sm rounded">
          Formulario de registro
        </button>
      </div>

      {/* titulos adaptados para diferentes tamaños */}
      <h1 className="text-2xl md:text-3xl font-bold">Congreso MAGNO 3.0</h1>

      <p className="text-gray-300 text-sm md:text-base hidden md:block">
        Complete el formulario para registrarse en el evento mas importante del
        año en Colombia, y ser parte de una experiencia inolvidable.
      </p>

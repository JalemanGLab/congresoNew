          ...
          <div className="w-full flex flex-col justify-center items-center gap-3">
            <div className="w-full flex flex-col justify-center items-center gap-3">
              <div className="flex items-center justify-center w-full">
                <div className="text-3xl text-[#333333] text-center font-bold">
            ...
            <div className="text-[#333333] text-center text-sm">
              Complete el formulario para registrarse y acceder a nuestros
            ...
            <div className="flex flex-col items-center w-1/3 relative z-10">
              <div
                className={`flex justify-center items-center w-14 h-14 rounded-full ${
                  step >= 1
                    ? "bg-gradient-to-b from-[#000000] to-[#464646]"
                    : "bg-[#D9D9D9]"
                }`}
              >
                <HiOutlineUser
                  className={`text-3xl ${
                    step >= 1 ? "text-white" : "text-[#666666]"
                  }`}
                />
              </div>
          ...
          <div className="w-full bg-white flex flex-col rounded-lg p-10 gap-5 shadow-2xl">
            {step === 1 && (
              <div className="w-full flex flex-col gap-5">
                <div className="text-2xl text-[#333333] text-center font-bold">
                  Información personal
                </div>
                <div className="text-sm text-[#A0A0A0]">
                  Porfavor complete sus datos personales
                </div>
                <form
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <Link
                      href="/"
                      className="w-full flex items-center gap-2 px-4 py-2 rounded-l text-neutral-700 transition-colors duration-200"
                    >
            ...
            {step === 2 && (
              <div className="w-full flex flex-col gap-5">
                ...
                <div className="text-sm text-[#A0A0A0] text-center">
                  Porfavor complete sus datos profesionales
                </div>
                <form
            ...
            {step === 3 && (
              <form
                ...
                className="w-full flex flex-col gap-5"
              >
                <div className="text-2xl text-[#333333] font-bold">
                  Método de Pago
                </div>
                <div className="text-sm text-[#A0A0A0]">
